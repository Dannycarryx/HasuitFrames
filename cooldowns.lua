...
do
    ...
    local cdHeal    =   hasuitSpellFunction_Cleu_HealCooldownStart
    local cdCleE    =   hasuitSpellFunction_Cleu_SpellEmpowerStartCooldownStart2
    local cleAura   =   hasuitSpellFunction_Cleu_AppliedCooldownStart
    ...
    do
        ...
        do --shouldTrackUndead
            ...
            if playerClass=="PRIEST" or playerClass=="WARLOCK" or playerClass=="EVOKER" or playerClass=="WARRIOR" or playerClass=="DEMONHUNTER" then --todo or playerClass=="MONK" if playing sleep, if updating for classic might need to add hunter here for wyvern, and preferrably only if actually playing wyvern. Is anything missing?
                ...
                hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_AppliedRacialNotTrackedAffectingPvpTrinket,["loadOn"]=hasuitLoadOn_CooldownDisplay, --Will of the Forsaken --the point is player doesn't care as much about will but still wants to see its effect on real trinket's cd if used
                    ["minimumDuration"]=30,["differenceFromNormalDuration"]=-90}
    ...
    do
        ...
        hasuitFramesCenterSetEventType("cleu")
        -- hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_AppliedCooldownReductionSourceIsDest,["CDr"]=60,["affectedSpells"]={388615, 115310},["loadOn"]=hasuitLoadOn_CooldownDisplay} --peaceweaver
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_AppliedCooldownReductionSourceIsDest,["CDr"]=30,["affectedSpells"]={388615, 115310},["loadOn"]=hasuitLoadOn_CooldownDisplay} --peaceweaver?
        ...
        hasuitFramesCenterSetEventType("aura")
        hasuitSetupSpellOptions = {hasuitSpellFunction_Aura_HypoCooldownFunction,["affectedSpells"]={45438,414658,235219},["affectedSpellsPairs"]={[45438]=true,[414658]=true,[235219]=true},["unitClass"]="MAGE",["loadOn"]=hasuitLoadOn_CooldownDisplay}
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Aura_Points1CooldownReduction,["CDr"]=30,["affectedSpells"]={108271},["loadOn"]=hasuitLoadOn_CooldownDisplay,["points1"]=-40} --Astral Shift
        ...
        do
            ...
            hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_AppliedCooldownReductionThiefsBargain354827,["CDr"]=24,["affectedSpells"]={11327},["loadOn"]=hasuitLoadOn_CooldownDisplay} --Vanish
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReduction,["CDr"]=3,["affectedSpells"]={33206},["loadOn"]=hasuitLoadOn_CooldownDisplay} --Pain Suppression, todo ignore unless disc and tracking pain supp
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_HealCooldownReduction,["CDr"]=-108.9,["affectedSpells"]={47788},["loadOn"]=hasuitLoadOn_CooldownDisplay} --Guardian Spirit
    ...
    do
        ...
        -- }
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_EnergizeCooldownReduction,["CDr"]=3,["affectedSpells"]={47528},["loadOn"]=hasuitLoadOn_CooldownDisplay}--Mind Freeze
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_InterruptCooldownReduction,["CDr"]=4,["affectedSpells"]={2139},["loadOn"]=hasuitLoadOn_CooldownDisplay}
    ...
    do --be careful not to overlap priority with an interrupt now that they're separated but still close in priority like this
        ...
        do
            ...
            hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SpellEmpowerInterruptCooldownReduction,["CDr"]="reset",["affectedSpells"]={382266, 357208},["loadOn"]=hasuitLoadOn_CooldownDisplay} --Fire Breath, could have just done like 10000 for cdr instead of having "reset" be a thing?
            initialize(382266) --Fire Breath
            initialize(357208) --Fire Breath
            hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_AppliedCooldownReduction,["CDr"]=3,["affectedSpells"]={357210, 433874, 442204},["loadOn"]=hasuitLoadOn_CooldownDisplay} --Deep Breath, bored todo 3 sec cap? might not get reached every time, assuming i understand how this works from reading the tooltip
        ...
        -- }
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_InterruptCooldownReduction,["CDr"]=5,["affectedSpells"]={115078},["loadOn"]=hasuitLoadOn_CooldownDisplay} --paralysis, do people take [Energy Transfer]?
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_AppliedCooldownReductionSourceIsDest,["CDr"]="reset",["affectedSpells"]={213691},["loadOn"]=hasuitLoadOn_CooldownDisplay} --Scatter Shot
        ...
        local hoj = {853}
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReduction,["CDr"]=6,["affectedSpells"]=hoj,["loadOn"]=hasuitLoadOn_CooldownDisplay} --Hammer of Justice
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReduction,["CDr"]=10,["affectedSpells"]=hoj,["loadOn"]=hasuitLoadOn_CooldownDisplay} --Hammer of Justice
        ...
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReduction,["CDr"]=16,["affectedSpells"]=hoj,["loadOn"]=hasuitLoadOn_CooldownDisplay} --Hammer of Justice
    ...
    if #shiftingPowerAffectedSpells>0 then
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReduction,["CDr"]=3,["affectedSpells"]=shiftingPowerAffectedSpells,["loadOn"]=hasuitLoadOn_CooldownDisplay}
        initialize(382445) --Shifting Power CDr
    end
    if #coldSnapAffectedSpells>0 then
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReduction,["CDr"]="reset",["affectedSpells"]=coldSnapAffectedSpells,["loadOn"]=hasuitLoadOn_CooldownDisplay}
        initialize(235219) --Cold Snap
    end
    
    
    if #vanishAffectedSpells>0 then
        hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_SuccessCooldownReductionSpec,["CDr"]=22.5,["affectedSpells"]=vanishAffectedSpells,["specId"]=261,["loadOn"]=hasuitLoadOn_CooldownDisplay}
    ...
    hasuitSetupSpellOptions = {hasuitSpellFunction_Cleu_378441TimeStop,["loadOn"]=hasuitLoadOn_CooldownDisplay} --Time Stop cooldown pause
    initialize(378441)
    ...
    if #timeSkipAffectedSpells>0 then
        hasuitFramesCenterSetEventType("aura")
        hasuitSetupSpellOptions = {hasuitSpellFunction_Aura_DurationCooldownReduction,["CDr"]=30,["affectedSpells"]=timeSkipAffectedSpells,["loadOn"]=hasuitLoadOn_CooldownDisplay,["duration"]=3} --todo assume 10% until cast duration is seen and then change it if 3 sec talent is taken? hopefully aug gets tank treatment so this doesn't matter much except in m+
        initialize(404977) --Time Skip
        hasuitSetupSpellOptions = {hasuitSpellFunction_Aura_DurationCooldownReduction,["CDr"]=20,["affectedSpells"]=timeSkipAffectedSpells,["loadOn"]=hasuitLoadOn_CooldownDisplay,["duration"]=2}
        initialize(404977) --Time Skip
    end
