...
for i=1,3 do
	commonBigGroupDebuffs[i] = {["frameLevel"]=20,	["hideCooldownText"]=false,	["alpha"]=1}
	commonBigBottomLeftArena[i] =	 {			["hideCooldownText"]=false,	["alpha"]=1,	["controller"]=danBottomRight_BottomLeft,	["size"]=bigGroupDebuffsParty[i],	["frameLevel"]=20,	}
end
for i=4,7 do
	commonBigGroupDebuffs[i] = {["frameLevel"]=20,	["hideCooldownText"]=true,	["alpha"]=1}
	commonBigBottomLeftArena[i] =	 {			["hideCooldownText"]=true,	["alpha"]=1,	["controller"]=danBottomRight_BottomLeft,	["size"]=bigGroupDebuffsParty[i],	["frameLevel"]=20,	}
end
...
hasuitSetupFrameOptions = {danCleuInterrupted,	["duration"]=2,			["priority"]=-48,						["group"]=commonBigGroupDebuffs[4],	["arena"]=commonBigBottomLeftArena[4],} --interrupts, hasuitKICKTextKey = "KICKArena" or "KICKRbg" gets set in loading profile above
initialize(91807) --Shambling Rush
initialize(57994) --Wind Shear
hasuitSetupFrameOptions = {danCleuInterrupted,	["duration"]=3,			["priority"]=-48,						["group"]=commonBigGroupDebuffs[4],	["arena"]=commonBigBottomLeftArena[4],} --, todo low priority spell schools, maybe hide completely
...
hasuitSetupFrameOptions = {danCleuInterrupted,	["duration"]=4,			["priority"]=-48,						["group"]=commonBigGroupDebuffs[4],	["arena"]=commonBigBottomLeftArena[4],}
...
hasuitSetupFrameOptions = {danCleuInterrupted,	["duration"]=5,			["priority"]=-48,						["group"]=commonBigGroupDebuffs[4],	["arena"]=commonBigBottomLeftArena[4],}
initialize(97547) --Solar Beam
initialize(2139) --Counterspell
initialize(19647) --Spell Lock
initialize(132409) --Spell Lock
hasuitSetupFrameOptions = {danCleuInterrupted,	["duration"]=6,			["priority"]=-48,						["group"]=commonBigGroupDebuffs[4],	["arena"]=commonBigBottomLeftArena[4],}
