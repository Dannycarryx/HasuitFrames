...
local danCommon = {["controller"]=danController_BottomRight_BottomRightHots1, ["size"]=15, ["alpha"]=1,    }
hasuitSetupSpellOptions = {hasuitSpellFunction_AuraSourceIsPlayer,      ["priority"]=0,                                 ["group"]=danCommon,    ["specialAuraFunction"]=hasuitSpecialAuraFunction_RedLifebloom,} hasuitUsedRedLifebloom = true
initialize(188550   ) --lifebloom
initialize(33763    ) --lifebloom, todo only cd text if low duration?


local danCommon = {["controller"]=danController_BottomRight_BottomRightHots2, ["size"]=15, ["alpha"]=1,    ["hideCooldownText"]=true,  ["specialIconType"]="optionalBorder"} --what's the difference between local common here and not having local? seems like if anything it would be better to do it like this, or maybe significantly better
...
local danCommon = {["controller"]=danController_BottomRight_BottomRightHots4, ["size"]=14, ["alpha"]=1,    ["hideCooldownText"]=true,  ["specialIconType"]="optionalBorder"}
...
-- local danCommon = {["controller"]=danController_BottomRight_BottomRightHots6, ["size"]=15, ["alpha"]=1,     ["hideCooldownText"]=true,  }
...
-- local danCommon = {["controller"]=danController_BottomRight_BottomRightHots6, ["size"]=15, ["alpha"]=0.4, ["hideCooldownText"]=true,    }
-- hasuitSetupSpellOptions = {hasuitSpellFunction_AuraSourceIsPlayer,      ["priority"]=1,                             ["group"]=danCommon,}
