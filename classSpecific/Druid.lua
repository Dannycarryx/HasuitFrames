...
local common = {["controller"]=danBottomRightHots2, ["size"]=15,    ["frameLevel"]=21,  ["alpha"]=1,    ["hideCooldownText"]=true,  ["specialIconType"]="optionalBorder"} --what's the difference between local common here and not having local? seems like if anything it would be better to do it like this, or maybe significantly better
...
local common = {["controller"]=danBottomRightHots4, ["size"]=14,    ["frameLevel"]=21,  ["alpha"]=1,    ["hideCooldownText"]=true,  ["specialIconType"]="optionalBorder"}
...
local common = {["controller"]=danBottomRightHots4, ["size"]=13,    ["frameLevel"]=21,  ["alpha"]=1,    ["hideCooldownText"]=true,  }
...
local common = {["controller"]=danBottomRightHots4, ["size"]=12,    ["frameLevel"]=21,  ["alpha"]=1,    ["hideCooldownText"]=true,  }
...
local common = {["controller"]=danBottomRightHots5, ["size"]=14,    ["frameLevel"]=21,  ["alpha"]=1,    ["hideCooldownText"]=true,  }
...
-- local common = {["controller"]=danBottomRightHots6, ["size"]=15,    ["frameLevel"]=21, ["alpha"]=1,     ["hideCooldownText"]=true,  }
-- hasuitSetupFrameOptions = {auraSourceIsPlayer,          ["priority"]=1,                             ["group"]=common,}
-- initialize(102352    ) --cenarion ward after proc
-- local common = {["controller"]=danBottomRightHots6, ["size"]=15,    ["frameLevel"]=21, ["alpha"]=0.4, ["hideCooldownText"]=true,    }
-- hasuitSetupFrameOptions = {auraSourceIsPlayer,          ["priority"]=1,                             ["group"]=common,}
