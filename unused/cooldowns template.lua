do
	...
	defensiveCooldowns["EVOKER"]={ --todo wing buffet, tail swipe?
	}
	defensiveCooldowns[1467]={--Devastation
	}
	defensiveCooldowns[1468]={--Preservation
	}
	...
	defensiveCooldowns[70]={--Retribution
	}
end